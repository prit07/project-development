    ...
    <>
      <section className=" bg-white">
        <div className="page-header py-5 ">
          ...
          >
            <h1 className="display-3 text-white fw-bold slideInRight">About Us</h1>
          ...
          <Row className="py-lg-5">
            ...
            <Col lg={6} className="ps-4">
              <div className="about-capital ">
                ...
                <h2 className=" fw-bold text-blue fs-1"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                  We Are Leader In <br />
                  Industrial Market
                </h2>
                <p className="text-secondary mt-3" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
              ...
              <div className="d-flex align-items-center " data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
              ...
              <Row>
                <div className="col-sm-6"data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
